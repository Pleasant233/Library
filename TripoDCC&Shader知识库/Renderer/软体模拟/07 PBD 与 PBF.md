...
> 进阶篇。恭喜——跟到这里，你已经拼出一个能跑的完整软体求解器了。现在停下来往回看：02–06 我们一层层加的约束，其实背后是同一个框架 **PBD**。这一篇帮你把散落的点连成线，再顺势看懂参考项目 Unity_Slime 的流体方案 **PBF** 为什么和我们「本是同根生」。
